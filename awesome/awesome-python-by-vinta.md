...
A curated list of [awesome Python frameworks](https://github.com/vinta/awesome-python/), libraries, software and resources.
Please see [jobbole/awesome-python-cn](https://github.com/jobbole/awesome-python-cn/) for Chinese version.
...
* [bpython](https://github.com/bpython/bpython) ®C A fancy interface to the Python interpreter.
...
* General
    ...
    * [xpinyin](https://github.com/lxneng/xpinyin) - A library to translate Chinese hanzi (ùh◊÷) to pinyin (∆¥“Ù).
* Slugify
...
* Markdown
    ...
    * [Python-Markdown](https://github.com/waylan/Python-Markdown) - A Python implementation of John Gruber°Øs Markdown.
* YAML
...
* [Cactus](https://github.com/koenbok/Cactus/) ®C Static site generator for designers.
